...
export interface SkinScanReportModalProps {
  open: boolean;
  onClose: () => void;
  userName: string;
  age?: number;
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative z-10 my-auto w-full max-w-3xl overflow-hidden rounded-[22px] border border-white/60"
        style={{
      ...
      >
        ...
        <div className="relative px-5 pb-28 pt-9 sm:px-9 sm:pb-32">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-[1fr_auto_1fr] lg:items-start lg:gap-5">
            ...
            >
              <div
                className="relative aspect-[3/4] w-full overflow-hidden rounded-[18px] bg-zinc-200 ring-1 ring-black/[0.06] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.18),0_8px_16px_-6px_rgba(0,0,0,0.08)]"
              >
                <div
